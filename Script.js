...
alert(`
    ...
    Règles : Il s'agit d'un jeu snake dont le serpent est une poubelle de recyclage. Pour gagner, il faut recycler les objets correspondant à la bonne couleur de poubelle. 
    Le carreau au centre est donc une poubelle
    ...
    En triant vos déchets correctement, vous aidez à préserver les ressources et à réduire la pollution. Respectez les couleurs pour un recyclage efficace !`);
        ...
        updateSnake();
        drawGame();
        // Augmenter la valeur à 300 pour ralentir la vitesse du jeu
        setTimeout(gameLoop, 300); // Plus la valeur est grande, plus le jeu est lent
    }
